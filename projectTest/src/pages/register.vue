        ...
        <v-card>
          ...
          <v-card-text>
            <v-form ref="form">
              ...
              <div>
                <h2>Password:</h2>
                <v-text-field label="Password" :append-icon="showPassword ? 'mdi-eye' : 'mdi-eye-off'" v-model="password" :rules="passwordRules"
                :type="showPassword ? 'text' : 'password'" @click:append="togglePassword" required
                ></v-text-field>
              </div>
              <!-- Confirm Password -->
              <div>
